...
export const EditProduct = ({ onClose, display, product }: Props) => {
    ...
    const handleSubmit = (event: any) => {
        ...
        // pasar producto como parametro para llenar los campos
    ...
    return (
        <>
            <Dialog header="Product Details" visible={display} style={{ width: '50vw' }} footer={renderFooter('displayBasic')} onHide={() => onHide()}>
